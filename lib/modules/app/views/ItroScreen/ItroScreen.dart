    ...
    return Scaffold(
      body: DecoratedBox(
        ...
        child: CustomGradientCard(
          gradient: AppColor.itroGradient,
          child: Column(
            children: [
              const Spacer(),
              Expanded(
      ...
      child: ScaleTransition(
        ...
        child: Card(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: widget.color ?? Colors.purple.shade300,
...
List<Onboarding> onboardingList = [
  Onboarding(
    bgImage: AppAssets.first,
    title: 'Create Your Own Task Scheduler',
    info:
        'Semper in cursus magna et eu varius nunc adipiscing. Elementum justo, laoreet id sem . ',
  ),
  Onboarding(
    bgImage: AppAssets.second,
    title: "Easy to use And Perform Task on Time",
    info:
        'Semper in cursus magna et eu varius nunc adipiscing. Elementum justo, laoreet id sem . ',
  ),
];
